...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'        => 'Cadastro Solicitantes',
            'url'         => 'admin/solicitante',
            'icon'        => 'far fa-bell-o',
            'label'       => 4,
            'label_color' => 'success',
        ],
        [
            'text'        => 'Cadastro Convênios',
            'url'         => 'admin/convenios',
            'icon'        => 'far fa-file',
            'label'       => 4,
            'label_color' => 'success',
        ],
        ['header' => 'CONFIGURAÇÃO DE USUÁRIOS'],
        [
            'text' => 'profile',
            'url'  => 'admin/settings',
